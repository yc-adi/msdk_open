...
const uint8_t attCgmsSvcUuid[ATT_16_UUID_LEN] =    {UINT16_TO_BYTES(ATT_UUID_CGM_SERVICE)};
...
const uint8_t attCgmmChUuid[ATT_16_UUID_LEN] =     {UINT16_TO_BYTES(ATT_UUID_CGM_MEAS)};
...
const uint8_t attCgmfChUuid[ATT_16_UUID_LEN] =     {UINT16_TO_BYTES(ATT_UUID_CGM_FEATURE)};
const uint8_t attCgmStChUuid[ATT_16_UUID_LEN] =    {UINT16_TO_BYTES(ATT_UUID_CGM_STATUS)};
const uint8_t attCgmSessStartTChUuid[ATT_16_UUID_LEN] = {UINT16_TO_BYTES(ATT_UUID_CGM_SESS_START_T)};
const uint8_t attCgmSessRunTChUuid[ATT_16_UUID_LEN] =   {UINT16_TO_BYTES(ATT_UUID_CGM_SESS_RUN_T)};
const uint8_t attCgmSopsChUuid[ATT_16_UUID_LEN] =  {UINT16_TO_BYTES(ATT_UUID_CGM_SOPS)};
