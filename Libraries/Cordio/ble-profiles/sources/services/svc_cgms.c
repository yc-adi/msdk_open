...
static const uint8_t cgmsRacpValPerm = ATTS_PERMIT_WRITE | ATTS_PERMIT_WRITE_AUTH;
...
static const uint8_t cgmsRacpChCccdPerm = ATTS_PERMIT_WRITE | ATTS_PERMIT_WRITE_AUTH;
