...
typedef enum
{
  ...
  MSG_T_LCTR_SEND_CONN_MSG,
  MSG_T_LCTR_TX_FEAT_RSP,
  MSG_T_LL_ADV_REPORT_IND,
  MSG_T_LL_EXT_ADV_REPORT_IND,
  MSG_T_LL_PER_ADV_REPORT_IND,
  MSG_T_LL_PDU_FEATURE_REQ,
  MSG_T_LL_PDU_LENGTH_REQ,
  MSG_T_LL_PDU_LENGTH_RSP,
  MSG_T_LL_PDU_SLV_FEATURE_REQ
} MSG_t;
